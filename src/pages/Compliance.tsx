              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <p className="text-slate-300 text-lg leading-relaxed select-none">
                    Professional documentation and verification materials for business 
                    partners, banks, and regulatory purposes. Secure access with reference 
                    IDs for every document release.
                  </p>
                </div>
                  ...
                  {[
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className={`${stat.size} font-bold select-none break-words leading-tight`}>{stat.value}</p>
                      </div>
                    );
                  })}
                </div>
                <div className="flex flex-wrap gap-4 mt-8">
                  <Button size="lg" className="group/btn relative gap-2 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 text-white hover:scale-105 shadow-[0_0_30px_rgba(56,189,248,0.4)] hover:shadow-[0_0_50px_rgba(56,189,248,0.6)] transition-all duration-300 cursor-pointer select-none" asChild>
                    <a href="#verification">
                      {/* Glow effect */}
                  ...
                  <Button variant="outline" size="lg" className="group/btn relative gap-2 border-cyan-400/30 bg-slate-900/80 backdrop-blur-xl text-cyan-300 hover:text-white hover:border-cyan-400 hover:scale-105 shadow-[0_0_20px_rgba(56,189,248,0.2)] hover:shadow-[0_0_30px_rgba(56,189,248,0.4)] transition-all duration-300 cursor-pointer select-none">
                    {/* Glow effect */}
                    ...
                    <span className="relative z-10 pointer-events-none">View Documents</span>
                  </Button>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-3 mt-8">
              {[
                ...
                return (
                  ...
                  >
                    <div className={`inline-flex h-12 w-12 items-center justify-center rounded-2xl border ${step.color === "cyan" ? "border-cyan-400/30 bg-cyan-500/20" : step.color === "blue" ? "border-blue-400/30 bg-blue-500/20" : "border-purple-400/30 bg-purple-500/20"} group-hover/step:scale-110 transition-transform duration-300`}>
                      <Icon className={`h-5 w-5 ${step.color === "cyan" ? "text-cyan-400" : step.color === "blue" ? "text-blue-400" : "text-purple-400"} group-hover/step:drop-shadow-[0_0_10px_currentColor]`} />
                    </div>
                    <p className="text-xs uppercase tracking-[0.4em] text-slate-400 font-bold select-none">
                      Step {index + 1}
                    </p>
                    <h3 className="text-xl font-bold text-white select-none">{step.title}</h3>
                    <p className="text-slate-300 leading-relaxed select-none">{step.copy}</p>
                  </div>
                );
              })}
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {documents.map((doc, index) => {
              ...
              const colorClasses = {
                ...
                purple: "border-purple-400/30 bg-slate-900/80 hover:border-purple-400/60",
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-4">
                      <div className={`inline-flex h-12 w-12 items-center justify-center rounded-2xl border group-hover:scale-110 transition-transform duration-300 ${iconColors[color as keyof typeof iconColors]}`}>
                    ...
                    <h3 className="text-xl font-bold text-white select-none">{doc.title}</h3>
              ...
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label htmlFor="company" className="text-slate-300 font-bold">Company / Institution *</Label>
                      <Input
                        id="company"
                        required
                  ...
                  <div>
                    <Label htmlFor="purpose" className="text-slate-300 font-bold">Purpose of Request *</Label>
                    <Input
                      id="purpose"
                      required
                  ...
                  <div className="flex items-start gap-3 rounded-2xl border border-cyan-400/30 bg-slate-900/80 backdrop-blur-xl p-4">
                    ...
                    >
                      I confirm the requested information will be used solely for legitimate 
                      business purposes.
                    </Label>
                  </div>
                  <Button 
                ...
                <div className="text-center space-y-4">
                  ...
                  <h3 className="font-serif text-2xl font-bold text-white select-none">Request Submitted</h3>
